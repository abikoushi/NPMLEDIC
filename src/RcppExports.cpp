...
// ep_DICT_em
List ep_DICT_em(const arma::vec& EL, const arma::vec& ER, const arma::vec& SL, const arma::vec& SR, const arma::vec& tmax, const arma::uvec& ctype, const arma::vec& breaks, const double& alpha0, const int& iter);
RcppExport SEXP _NPMLEDIC_ep_DICT_em(SEXP ELSEXP, SEXP ERSEXP, SEXP SLSEXP, SEXP SRSEXP, SEXP tmaxSEXP, SEXP ctypeSEXP, SEXP breaksSEXP, SEXP alpha0SEXP, SEXP iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type EL(ELSEXP);
    ...
    Rcpp::traits::input_parameter< const double& >::type alpha0(alpha0SEXP);
    Rcpp::traits::input_parameter< const int& >::type iter(iterSEXP);
    rcpp_result_gen = Rcpp::wrap(ep_DICT_em(EL, ER, SL, SR, tmax, ctype, breaks, alpha0, iter));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_NPMLEDIC_ep_DICT_em", (DL_FUNC) &_NPMLEDIC_ep_DICT_em, 9},
    {NULL, NULL, 0}
};
